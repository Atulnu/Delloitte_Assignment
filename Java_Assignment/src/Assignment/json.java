			 ...
			 String jsonStr = "{\n" +
			        ...
			        for (int i = 0; i < dataArray.length(); i++) {
			            ...
			            if (email.endsWith("@deloitte.com")) {
			                System.out.println("Valid email user:");
			                System.out.println("ID: " + userObj.getInt("id"));
			                System.out.println("Name: " + userObj.getString("first_name") + " " + userObj.getString("last_name"));
			                System.out.println("Email: " + email);
			                System.out.println("Avatar: " + userObj.getString("avatar"));
			                System.out.println();
			            } else {
			                userObj.put("email", "Not a valid email address");
